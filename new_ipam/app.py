...
def login_required(func):
    ...
    def wrapper(*args, **kwargs):
        ...
        if not user:
            # 如果是 API 请求或客户端明确接受 JSON，则返回 JSON 错误
